...
const GastosVariables = () => {
  ...
  const totalGeneral = totalGastosVehiculos + totalGastosOtros;
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {[...gastosVehiculosDelMes, ...gastosOtros.filter(g => {
                    ...
                    <TableRow key={`${gasto.categoria}-${gasto.id}`}>
                      ...
                      <TableCell>
                        <Badge variant={gasto.categoria === 'vehiculo' ? 'default' : 'secondary'}>
                          {gasto.categoria === 'vehiculo' ? 'Vehículo' : 'Otros'}
                        </Badge>
                      </TableCell>
